    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/modifyuser" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" value="${requestScope.user.name}" placeholder="请输入姓名" />
          </div>
          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
              <input type="text" name="address" id="address" value="${requestScope.user.address}" class="form-control" />
          </div>
